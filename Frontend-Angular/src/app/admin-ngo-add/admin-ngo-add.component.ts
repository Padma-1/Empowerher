...
@Component({
  selector: 'app-admin-ngo-add',
  templateUrl: './admin-ngo-add.component.html',
  styleUrls: ['./admin-ngo-add.component.css']
})
export class AdminNgoAddComponent implements OnInit {
