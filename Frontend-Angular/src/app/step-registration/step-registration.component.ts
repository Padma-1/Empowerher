...
{
  selectedStatus = "Select Maritial Status";
  ...
  constructor(private formBuilder:FormBuilder,private http:HttpClient,
              private traineeservice:TraineeService, private router:Router) { }
...
fileChange(event: any) 
{
  ...
  onSubmit()
  {
    ...
    if(this.registerForm.invalid)
    {
    ...
    else
      {
        ...
        {
          alert('This User has already registered an Trainee, navigating to status');
          this.router.navigate(['step-status']);
        }
  ...
  gotoList()
  {
    this.router.navigate(['step-registration-confirm']);
  }
